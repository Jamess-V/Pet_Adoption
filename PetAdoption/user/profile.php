            ...
            <div class="my-profile">
                ...
                <div class="profile-info">
                    <div class="info-field">
                        <input type="text" value="Bob" readonly>
                    </div>

                    <div class="info-field">
                        <input type="email" value="Bob@gmail.com" readonly>
                    </div>

                    <div class="info-field">
                        <input type="tel" value="(66) 123-4567" readonly>
                    </div>

                    <div class="info-field">
                        <input type="text" value="123 ABAC Street, Thailand, 15100" readonly>
                    </div>

                    <div class="info-field">
                        <textarea readonly>Animal lover with 10+ years of pet care experience</textarea>
                    </div>

                    <button class="edit-btn" onclick="window.location.href='editProfile.html'">Edit</button>
                </div>
            </div>
        </div>
    </div>
